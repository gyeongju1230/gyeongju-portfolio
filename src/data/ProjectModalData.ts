...
const ProjectModalData = {
  portfolio: {
    ...
    skills: 'SKILLS',
    period: '프로젝트 진행기간',
    periodContent: '2024.04.02 - 2024.05.',
    role: '역할',
    features: '주요 기능',
    featuresContent: [
      {
  ...
  todo: {
    ...
    introduction: '프로젝트 소개',
    introductionContent:
      'Todo Service 는 직접 여러 Todo 어플을 사용해보고 느낀 불편함을 개선하여 일정 관리를 더욱 쉽고 편리하게 할 수 있도록 제작한 \n' +
      '반응형 웹사이트입니다.',
    skills: 'SKILLS',
    period: '프로젝트 진행기간',
  ...
  sagopasam: {
    ...
    introduction: '프로젝트 소개',
    introductionContent:
      '사고파삼은 단국대학교(죽전캠) 학우들과 협업하여 제작한 전공서적 중고거래 애플리케이션입니다. \n' +
    ...
    planningBackgroundContent:
      '사고파삼 의 개발 동기는 대학생들의 전공서적 비용 문제와 불법 제본 문제에 대한 인식에서 시작하였습니다. \n' +
      '알바몬의 설문 결과(2020 알바몬 자체 설문조사 결과)에 따르면, 대학생의 평균 월 생활비 중 전공서적 비용이 상당한 부분을 차지한다고 합니다. \n' +
      '이로 인해 전공서적을 불법 제본하는 사례가 늘어나고 있고, 이러한 불법 행위는 저작권 침해뿐만 아니라 출판 및 콘텐츠 산업 시장까지 침체시키는 결과를 초래합니다. 뿐만 아니라, 자체 설문 결과(2021.03-2021.05) 대학생들이 전공서적을 버리는 경우도 빈번히 발생하고 있었고, 이로 인해 많은 책이 폐기되었습니다. 기존의 중고 거래 플랫폼의 문제점들을 해결하여 안전하고 합리적인 가격에 빠르게 거래할 수 있는 플랫폼이 필요하다는 인식에서 사고파삼이 탄생하게 되었습니다.\n' +
      '\n' +
  ...
  deunbung: {
    ...
    planningBackgroundContent:
      ...
      '개발팀과 디자인팀은 이전에 함께 프로젝트를 진행한 멤버들끼리 모였고, 기획팀은 사장님의 소중한 추천 덕분에 신속하게 구성되었습니다. \n' +
